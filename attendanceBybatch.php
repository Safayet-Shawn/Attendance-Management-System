...
if($_SERVER['REQUEST_METHOD']=='POST'){
	...
	if($find){
		header("location:atn.php?batch=".$batch);
	}else{
		echo $no="<div class='alert alert-danger'><strong>Sorry Cannt take attendance!!</strong>No student inserted in <strong>".$batch. "</strong>  Batch</div>";
...
<style>
	.c{
     ...
     <div class=" well text-center">
     	<h2>Take Attendance by Batch</h2>
     </div>
